...
impl UserName {
    fn new(first_name: String, last_name: String) -> Self {
        let mut result = Self {first_name: first_name, last_name: last_name, calendar_name: None};
        result.calendar_name = UserName::calculate_calendar_name(&result.first_name, &result.last_name);
        result
    }
