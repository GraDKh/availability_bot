...
fn main() {
    ...
    let bot_api = Api::from_token(&configuration.bot_token).expect("Couldn't create API object for bot");
    ...
    let mut data_saver = save_load_state::create_data_saver(&configuration.data_file);
